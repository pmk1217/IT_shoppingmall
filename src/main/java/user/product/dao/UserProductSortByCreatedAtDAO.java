...
public class UserProductSortByCreatedAtDAO extends MySQLConnector {

	Connection conn = null;

	public UserProductSortByCreatedAtDAO() {
		this.conn = getConnection();
	}

	public List<UserProductVO> productSortByCreatedAt(String category) {
		...
		try {
			...
			System.err.println("productSortByCreatedAt() ERR : " + e.getMessage());
		} finally {
			close(conn, pstmt, rs);
		}
