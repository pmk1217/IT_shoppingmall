        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">010-000-0000</a>
                </div>
                <div>
                	<c:choose>
					<c:when test="${adminLoginInfo == null}">
	                	<a href="${contextPath}/admins/adminLogin.jsp"  style="color:white; text-decoration-line:none; font-size:15px;"> 관리자 </a>
					</c:when>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                 ...
                 <!--     <a class="nav-icon d-none d-lg-inline" href="#" data-bs-toggle="modal" data-bs-target="#templatemo_search">
                     ...
                     <a class="nav-icon position-relative text-decoration-none" href="${contextPath}/users/login.jsp">
                       <b>로그인 </b>
